...
class _PreActResNet(nn.Module):
    def __init__(self, block, num_blocks, num_classes=10):
        super(_PreActResNet, self).__init__()
        self.in_planes = 64
...
def PreActResNet(num, num_classes=10):
    if num == 18:
        return _PreActResNet(PreActBlock, [2, 2, 2, 2], num_classes=num_classes)
    elif num == 34:
        return _PreActResNet(PreActBlock, [3, 4, 6, 3], num_classes=num_classes)
    elif num == 50:
        return _PreActResNet(PreActBottleneck, [3, 4, 6, 3], num_classes=num_classes)
    elif num == 101:
        return _PreActResNet(PreActBottleneck, [3, 4, 23, 3], num_classes=num_classes)
    elif num == 152:
        return _PreActResNet(PreActBottleneck, [3, 8, 36, 3], num_classes=num_classes)
    else:
